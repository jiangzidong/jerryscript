...
{
  JERRY_ASSERT (operand.type != UNINITIALIZED);

  return (operand.type == EMPTY);
...
jsp_is_this_operand (jsp_operand_t operand) /**< operand */
{
  ...
  return (operand.type == THIS_BINDING);
} /* jsp_is_this_operand */
...
jsp_is_simple_value_operand (jsp_operand_t operand) /**< operand */
{
  ...
  return (operand.type == SIMPLE_VALUE);
...
jsp_is_number_lit_operand (jsp_operand_t operand) /**< operand */
{
  ...
  return (operand.type == NUMBER_LITERAL);
...
jsp_is_string_lit_operand (jsp_operand_t operand) /**< operand */
{
  ...
  return (operand.type == STRING_LITERAL);
...
jsp_is_regexp_lit_operand (jsp_operand_t operand) /**< operand */
{
  ...
  return (operand.type == REGEXP_LITERAL);
...
jsp_is_identifier_operand (jsp_operand_t operand) /**< operand */
{
  ...
  return (operand.type == IDENTIFIER);
...
jsp_operand_get_idx (jsp_operand_t operand) /**< operand */
{
  ...
  if (operand.type == STRING_LITERAL || operand.type == NUMBER_LITERAL)
  {
    return VM_IDX_REWRITE_LITERAL_UID;
  }

  if (operand.type == THIS_BINDING)
  {
    return VM_REG_SPECIAL_THIS_BINDING;
  }

  JERRY_ASSERT (operand.type == EMPTY);
  return VM_IDX_EMPTY;
} /* jsp_operand_get_idx */
...
jsp_operand_get_literal (jsp_operand_t operand) /**< operand */
{
  ...
  if (operand.type == STRING_LITERAL
      || operand.type == NUMBER_LITERAL
      || operand.type == REGEXP_LITERAL)
  {
...
dumper_is_eval_literal (jsp_operand_t obj) /**< byte-code operand */
{
  ...
  bool is_eval_lit = jsp_is_identifier_operand (obj) && lit_literal_equal_type_cstr (lit, "eval");
