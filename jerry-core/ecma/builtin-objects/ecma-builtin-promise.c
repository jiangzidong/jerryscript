                                           ...
                                           bool is_inc) /**< whether to increase the count */
{
  ...
  ecma_length_t current = ecma_get_uint32_from_value (ext_object_p->u.class_prop.u.value);
                                  ...
                                  const ecma_length_t argc) /**< argument number */
{
  ...
  ecma_string_t *str_0 = ecma_new_ecma_string_from_uint32 (0);
  ecma_value_t already_called =  ecma_op_object_get (function_p, str_0);
  ...
  ecma_string_t *str_1 = ecma_new_ecma_string_from_uint32 (1);
  ecma_string_t *str_2 = ecma_new_ecma_string_from_uint32 (2);
  ecma_string_t *str_3 = ecma_new_ecma_string_from_uint32 (3);
  ecma_string_t *str_4 = ecma_new_ecma_string_from_uint32 (4);

  /* 4-7. */
  ecma_value_t index_val = ecma_op_object_get (function_p, str_1);
  ecma_value_t value_array = ecma_op_object_get (function_p, str_2);
  ecma_value_t capability = ecma_op_object_get (function_p, str_3);
  ecma_value_t remaining = ecma_op_object_get (function_p, str_4);

  JERRY_ASSERT (ecma_is_value_integer_number (index_val));

  /* 8. */
  ecma_string_t *str_index = ecma_new_ecma_string_from_uint32 (ecma_get_uint32_from_value (index_val));
  ...
  ecma_deref_ecma_string (str_1);
  ecma_deref_ecma_string (str_2);
  ecma_deref_ecma_string (str_3);
  ecma_deref_ecma_string (str_4);
                             ...
                             ecma_value_t ctor) /**< the caller of Promise.race */
{
  ...
  while (true)
  {
    ...
    /* l. String '0' indicates [[AlreadyCalled]]. */
    ecma_op_object_put (res_ele_p,
                        str_0,
                        ecma_make_boolean_value (false),
                        false);
    /* m. String '1' indicates [[Index]]. */
    ecma_op_object_put (res_ele_p,
                        str_1,
                        ecma_make_uint32_value (index),
                        false);
    /* n. String '2' indicates [[Values]]. */
    ecma_op_object_put (res_ele_p,
                        str_2,
                        value_array,
                        false);
    /* o. String '3' indicates [[Capabilities]]. */
    ecma_op_object_put (res_ele_p,
                        str_3,
                        capability,
                        false);
    /* p. String '4' indicates [[RemainingElements]]. */
    ecma_op_object_put (res_ele_p,
                        str_4,
                        remaining,
                        false);
